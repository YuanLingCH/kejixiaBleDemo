...
public interface apiManager {
    ...
    @FormUrlEncoded
    @POST("https://www.fzzsaas.com/member/news/ShortMessages")
    Call<String>getOuthCode(@Field("mobile") String s);

    // 注册接口
    //http://fzhuzhu.cn:8766/login/addUser?
    //  https://www.fzzsaas.com/permissionsUsers/login/addUser?
    @FormUrlEncoded
    @POST("https://www.fzzsaas.com/member/login/addUser?")
   ...
   // http://fzhuzhu.cn:8766/login/VerificationPhone?username=18617145277
    ...
    @FormUrlEncoded
    @POST("https://www.fzzsaas.com/member/login/VerificationPhone?")
