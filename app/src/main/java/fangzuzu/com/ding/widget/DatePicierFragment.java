...
public class DatePicierFragment {

    private static CustomDatePickerFrgment customDatePicker1, customDatePicker2;
    public DatePicierFragment() {
    }

    public static CustomDatePickerFrgment getCustomDatePicker1() {
        return customDatePicker1;
    }

    public static CustomDatePickerFrgment getCustomDatePicker2() {
...
*/
        ...
        customDatePicker2 = new CustomDatePickerFrgment(context, new CustomDatePickerFrgment.ResultHandler() {
            @Override
        ...
        customDatePicker1 = new CustomDatePickerFrgment(context, new CustomDatePickerFrgment.ResultHandler() {
            @Override
            public void handle(String time) { // 回调接口，获得选中的时间
