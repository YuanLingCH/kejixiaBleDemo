        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                //如果value中，包含 “不匹配”，表示登录失败
                    ...
                    //登录成功
                        loginBean.DataBean.UserDetailBean userDetail = data.getUserDetail();
                        ...
                        String refresh_token = ttsToken.getRefresh_token();
                        String scope = ttsToken.getScope();
                        SharedUtils.putString("access_token",access_token);
                        SharedUtils.putString("refresh_token",refresh_token);
                        SharedUtils.putString("scope",scope);
                        SharedUtils.putString("openid",openid+"");
