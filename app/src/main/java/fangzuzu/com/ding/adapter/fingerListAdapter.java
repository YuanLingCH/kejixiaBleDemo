...
public class fingerListAdapter extends RecyclerView.Adapter<fingerListAdapter.IcViewHolder> {
    ...
    private List<fingerBean.ListBean> mDatas;
    ...
    public fingerListAdapter(List<fingerBean.ListBean> mDatas,Context mContext) {
        this.mDatas = mDatas;
        this.mDatas = mDatas;
    ...
    public void onBindViewHolder(IcViewHolder holder, final int position) {
        final fingerBean.ListBean  bean= mDatas.get(position);

        final String cardName = bean.getFingerprintName();
        ...
        holder.re_adapter.setOnClickListener(new View.OnClickListener() {
            ...
            if (!startDate.equals("0")){
                ...
                intent.putExtra("icCardId",bean.getFingerprintId()+"");
