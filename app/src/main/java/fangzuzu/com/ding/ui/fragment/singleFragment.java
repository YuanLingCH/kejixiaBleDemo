...
/**
 * Created by lingyuan on 2018/10/18.
 */
...
public class singleFragment extends BaseFragment {
    ...
    protected void initViews() {
        ...
        // 密码在24小时内至少使用一次,否则失效  密码在生效时间6小时内使用
        String str="密码在<font color='#FF0000'>6小时内</font>至少使用一次,否则失效";
        tv.setTextSize(14);
                    ...
                    if (startTime<endTime&&startTime!=endTime){
                        ...
                        new AsyncTask<Void, Integer, String>() {
                            ...
                            protected String doInBackground(Void... params) {
                                ...
                                String json = ResponseService.getKeyboardPwd(lockId, 4, 1, kaishiTime, jieshuTime);
