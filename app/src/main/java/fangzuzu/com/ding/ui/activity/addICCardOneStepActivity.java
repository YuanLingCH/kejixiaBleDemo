...
public class addICCardOneStepActivity extends BaseActivity implements MainApplication.BleOperaddIcListenner,MainApplication.BleOperaddmodificationIcTListenner {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
     ...
     //   initHide();
       ...
       tTlockMac = getIntent().getStringExtra("tTlockMac");
        ...
        MainApplication.SetBleOperaddIcListennerr(this);
 ...
 String lockName;
                ...
                if (!StringUtils.isEmpty(lockName)){
                    if ( tglSound.isChecked()){
                        ...
                        if (mTTLockAPI.isBLEEnabled(MainApplication.getInstence())){
                            ...
                            MainApplication.bleSession.setOperation(Operation.ADD_ICCARD);
                            ...
                            //打开蓝牙设备
                            mTTLockAPI.requestBleEnable(addICCardOneStepActivity.this);
                        }
  ...
  public  void   addICAndshengfenzheng(){
   ...
   ;
     ...
     */
    @Override
    public void bleOperaddIc(Error error, long IcNumbler) {
        Log.d("TAG","添加IC回调"+error+IcNumbler);
        sendDataToService(error,IcNumbler,0,0); //永久
    }
     ...
     */
    @Override
    public void bleOperaddmodificationIcTime(Error error,  long IcNumbler) {
        Log.d("TAG","修改IC回调addICCardOneStepActivity"+error+l);   //  上传到服务器
        sendDataToService(error,IcNumbler,kaishi,jieshu);
    }
     ...
     * @param IcNumbler
     */
    public void sendDataToService(Error error, final long IcNumbler, final long kaishi1, final long jieshu1){
        if (error==Error.SUCCESS){
            ...
            new AsyncTask<Void, Void, String>() {
                ...
                protected String doInBackground(Void... params) {
                    ...
                    String json = ResponseService.AddIcCard(id, lockName, IcNumbler+"",kaishi1,jieshu1);  //1  表示通过蓝牙  2 网管
                    return json;
                }
            }.execute();
        }else {
