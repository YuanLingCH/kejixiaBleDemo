    ...
    private void initlize() {
        ...
        but_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String passwordjiami = MD5Utils.md5Password(repaw).toLowerCase();
                final String auth1 = MD5Utils.md5Password(auth + "fzz").toLowerCase();  //小写
                        ...
                        call.enqueue(new Callback<String>() {
                            ...
                            public void onResponse(Call<String> call, Response<String> response) {
                                ...
                                if (code.equals("1001")) {
                                    ...
                                    Toast.makeText(RegisterActivity.this, "账号已经注册", Toast.LENGTH_LONG).show();
                                    hideProgressDialog();
                                }
                            }
