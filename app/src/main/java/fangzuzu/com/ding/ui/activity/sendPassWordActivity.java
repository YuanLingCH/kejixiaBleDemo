    ...
    private void initview() {
      ...
      //  if (uid.equals(adminUserId)){
            ...
            tabLayout.addTab(tabLayout.newTab().setText("循环"));
             tabLayout.addTab(tabLayout.newTab().setText("单次"));
